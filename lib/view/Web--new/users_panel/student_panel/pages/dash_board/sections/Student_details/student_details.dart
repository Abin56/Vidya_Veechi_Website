import 'package:dujo_kerala_website/view/Web--new/users_panel/student_panel/pages/dash_board/sections/Student_details/attendence_graph.dart';
        ...
        ? Column(
            children: [
              ...
              Padding(
                ...
                child: SizedBox(height: 120, child: studentsDetailsPartList[1]),
              ),
            ],
          )
        : Row(
            children: [
              ...
              Padding(
                ...
                child: SizedBox(
                    height: 120, width: 180, child: studentsDetailsPartList[1]),
              ),
            ],
          );
  }
